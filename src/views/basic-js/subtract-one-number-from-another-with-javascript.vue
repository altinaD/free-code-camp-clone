  ...
  <div class="test-case">
    ...
    <div class="screen-divide">
      <div class="left-screen" ref="leftScreen">
        <LeftScreen>
          <h1>Subtract One Number from Another with JavaScript</h1>
          ...
          <Comment
            ...
            <span class="purple"> 6;</span></Comment
          >
          ...
          <ul class="tests">
            <li class="test">
              ...
              <p>
                The variable <Code> difference</Code> should equal
                <Code> 12</Code>.
              </p>
            </li>
            <li class="test">
              ...
              <p>You should only subtract one number from <Code>45</Code>.</p>
            </li>
          </ul>
        </LeftScreen>
      </div>
